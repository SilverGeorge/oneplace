        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-4">
          <div className="lg:col-span-2">
            ...
            <p className="mt-3 max-w-md text-sm text-slate-400">
              Manage listings, boost discoverability, and convert more customers with one platform.
            </p>
            <Link
              href="/signup"
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li>
                <Link
                  href="/"
                  className="text-sm text-slate-400 transition duration-300 hover:text-[#27ae60]"
                >
                  Home
                </Link>
              </li>
          ...
          <div>
            ...
            <div className="mt-5 flex items-center gap-3">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="text-slate-400 transition duration-300 hover:text-[#27ae60]"
                aria-label="Facebook"
              >
